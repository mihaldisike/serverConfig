...
zypper -n install php7 php7-devel php7-fpm composer php7-opcache php7-mbstring php7-fileinfo php7-curl php7-mysql php7-soap php7-shmop php7-tidy php7-intl php7-gd
